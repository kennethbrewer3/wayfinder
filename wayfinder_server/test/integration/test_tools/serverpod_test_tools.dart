...
class _MapMarkerEndpoint {
  ...
  _i3.Stream<_i10.MapMarkerChange> markerChanges(
    ...
    var _localTestStreamManager = _i1.TestStreamManager<_i10.MapMarkerChange>();
...
class _PmtilesEndpoint {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i11.PmtilesFile>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i12.PmtilesGroup>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i12.PmtilesGroup> createGroup(
    _i1.TestSessionBuilder sessionBuilder,
    String name,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i12.PmtilesGroup>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _AppSettingsEndpoint {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i13.AppSettings>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i13.AppSettings> updatePmtilesStoragePath(
    _i1.TestSessionBuilder sessionBuilder,
    String storagePath,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
