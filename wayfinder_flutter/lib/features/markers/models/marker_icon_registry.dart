...
const markerIconOptions = <MarkerIconOption>[
  ...
  MarkerIconOption(
    key: 'wildfire',
    icon: Icons.local_fire_department,
    assetPath: 'assets/markers/wildfire.svg',
    label: 'Wildfire',
  ),
  MarkerIconOption(
    key: 'tornado',
    icon: Icons.storm,
    assetPath: 'assets/markers/tornado.svg',
    label: 'Tornado',
  ),
  MarkerIconOption(
    key: 'hurricane',
    icon: Icons.cyclone,
    assetPath: 'assets/markers/hurricane.svg',
    label: 'Hurricane',
  ),
  MarkerIconOption(
    key: 'flood',
    icon: Icons.flood,
    assetPath: 'assets/markers/flood.svg',
    label: 'Flood',
  ),
  MarkerIconOption(
    key: 'storm',
    icon: Icons.thunderstorm,
    assetPath: 'assets/markers/storm.svg',
    label: 'Storm',
  ),
  MarkerIconOption(
    key: 'earthquake',
    icon: Icons.landslide,
    assetPath: 'assets/markers/earthquake.svg',
    label: 'Earthquake',
  ),
  MarkerIconOption(
    key: 'volcano',
    icon: Icons.volcano,
    assetPath: 'assets/markers/volcano.svg',
    label: 'Volcano',
  ),
  MarkerIconOption(
    key: 'tsunami',
    icon: Icons.tsunami,
    assetPath: 'assets/markers/tsunami.svg',
    label: 'Tsunami',
  ),
  MarkerIconOption(
    key: 'landslide',
    icon: Icons.landslide,
    assetPath: 'assets/markers/landslide.svg',
    label: 'Landslide',
  ),
  MarkerIconOption(
    key: 'drought',
    icon: Icons.wb_sunny,
    assetPath: 'assets/markers/drought.svg',
    label: 'Drought',
  ),
  MarkerIconOption(
    key: 'blizzard',
    icon: Icons.ac_unit,
    assetPath: 'assets/markers/blizzard.svg',
    label: 'Blizzard',
  ),
  MarkerIconOption(
    key: 'hail',
    icon: Icons.grain,
    assetPath: 'assets/markers/hail.svg',
    label: 'Hail',
  ),
  MarkerIconOption(
    key: 'snow',
    icon: Icons.snowing,
    assetPath: 'assets/markers/snow.svg',
    label: 'Snow',
  ),
  MarkerIconOption(
    key: 'icy_road',
    icon: Icons.severe_cold,
    assetPath: 'assets/markers/icy_road.svg',
    label: 'Icy road',
  ),
  MarkerIconOption(
    key: 'tree_down',
    icon: Icons.park,
    assetPath: 'assets/markers/tree_down.svg',
    label: 'Tree down',
  ),
  MarkerIconOption(
    key: 'power_line_down',
    icon: Icons.electric_bolt,
    assetPath: 'assets/markers/power_line_down.svg',
    label: 'Power line down',
  ),
  MarkerIconOption(
    key: 'high_wind',
    icon: Icons.air,
    assetPath: 'assets/markers/high_wind.svg',
    label: 'High wind',
  ),
  MarkerIconOption(
    key: 'ice_storm',
    icon: Icons.severe_cold,
    assetPath: 'assets/markers/ice_storm.svg',
    label: 'Ice storm',
  ),
  MarkerIconOption(
    key: 'road_blocked',
    icon: Icons.block,
    assetPath: 'assets/markers/road_blocked.svg',
    label: 'Road blocked',
  ),
  MarkerIconOption(
    key: 'power_outage',
    icon: Icons.power_off,
    assetPath: 'assets/markers/power_outage.svg',
    label: 'Power outage',
  ),
];
...
String? suggestMarkerIconForName(String name) {
  ...
  const suggestions = <String, String>{
    ...
    'downed tree': 'tree_down',
    'power line down': 'power_line_down',
    'downed power line': 'power_line_down',
    'downed line': 'power_line_down',
    'high wind': 'high_wind',
    'wind': 'high_wind',
    'gusts': 'high_wind',
    'ice storm': 'ice_storm',
    ...
    'blocked road': 'road_blocked',
    'road closed': 'road_blocked',
