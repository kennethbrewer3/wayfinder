...
--
-- Class GeocodeContribution as table geocode_contribution
--
...
-- Indexes
CREATE UNIQUE INDEX "geocode_contribution_content_key_idx" ON "geocode_contribution" USING btree ("contentKey");
CREATE INDEX "geocode_contribution_name_idx" ON "geocode_contribution" USING btree ("name");
...
CREATE TABLE "geocoding_settings" (
    ...
    "crowdsourceSourceUrl" text NOT NULL DEFAULT 'https://raw.githubusercontent.com/kennethbrewer3/wayfinder/main/geocoding-crowdsource/contributions.json'::text,
    "updatedAt" timestamp without time zone NOT NULL
);
