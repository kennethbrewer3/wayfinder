...
| `WAYFINDER_AUTH_REQUIRED` | No | Deprecated / unused for lockout; auth is required automatically once any user exists |
| `WAYFINDER_BOOTSTRAP_ADMIN_EMAIL` | No | Create first admin on startup (local username, not a mailbox) |
