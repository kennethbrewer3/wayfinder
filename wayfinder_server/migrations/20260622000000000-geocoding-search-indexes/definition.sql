...
CREATE TABLE "app_settings" (
    ...
    "homeZoom" double precision NOT NULL,
    "pmtilesStoragePath" text NOT NULL,
...
--
-- Class GeocodeHousenumber as table geocode_housenumber
--
...
CREATE INDEX "geocode_housenumber_street_trgm_idx" ON "geocode_housenumber" USING gin ("street" gin_trgm_ops);
CREATE INDEX "geocode_housenumber_housenumber_trgm_idx" ON "geocode_housenumber" USING gin ("housenumber" gin_trgm_ops);
CREATE INDEX "geocode_housenumber_label_trgm_idx" ON "geocode_housenumber" USING gin ((("housenumber" || ' ' || "street")) gin_trgm_ops);

--
-- Class GeocodePlace as table geocode_place
--
...
CREATE INDEX "geocode_place_name_trgm_idx" ON "geocode_place" USING gin ("name" gin_trgm_ops);
CREATE INDEX "geocode_place_display_name_trgm_idx" ON "geocode_place" USING gin ("displayName" gin_trgm_ops);

--
-- Class GeocodingSettings as table geocoding_settings
--
CREATE TABLE "geocoding_settings" (
    ...
    "housenumbersSourceUrl" text NOT NULL DEFAULT 'https://github.com/OSMNames/OSMNames/releases/download/v2.0.4/planet-latest_housenumbers.tsv.gz'::text,
    "housenumbersImportStatus" text NOT NULL DEFAULT 'idle'::text,
    "housenumbersImportedRowCount" bigint NOT NULL DEFAULT 0,
    "housenumbersImportProgress" double precision NOT NULL DEFAULT 0,
    "housenumbersImportError" text,
    "housenumbersImportedAt" timestamp without time zone,
    "updatedAt" timestamp without time zone NOT NULL
);

--
-- Class MapLayer as table map_layer
--
...
--
-- Class MapMarker as table map_marker
--
...
--
-- Class MapZone as table map_zone
--
...
--
-- Class PmtilesFile as table pmtiles_file
--
