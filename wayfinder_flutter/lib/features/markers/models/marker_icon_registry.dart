...
const markerIconOptions = <MarkerIconOption>[
  ...
  MarkerIconOption(
    ...
    assetPath: 'assets/markers/truck_stop.svg',
    label: 'Truck stop',
  ),
  MarkerIconOption(
    key: 'rest_stop',
    icon: Icons.park,
    assetPath: 'assets/markers/rest_stop.svg',
    label: 'Rest stop',
  ),
  MarkerIconOption(
    key: 'ev_charging_station',
    icon: Icons.electric_bolt,
    assetPath: 'assets/markers/ev_charging_station.svg',
  ...
  MarkerIconOption(
    key: 'public_restroom',
    icon: Icons.wc,
    assetPath: 'assets/markers/public_restroom.svg',
    label: 'Public restroom',
  ),
  MarkerIconOption(
    key: 'outhouse',
    icon: Icons.holiday_village,
    assetPath: 'assets/markers/outhouse.svg',
    label: 'Outhouse',
  ),
  MarkerIconOption(
    key: 'latrine',
    icon: Icons.construction,
    assetPath: 'assets/markers/latrine.svg',
    label: 'Latrine',
  ),
  MarkerIconOption(
    key: 'composting_toilet',
    icon: Icons.eco,
    assetPath: 'assets/markers/composting_toilet.svg',
    label: 'Composting toilet',
  ),
  MarkerIconOption(
    key: 'hand_wash_station',
    icon: Icons.wash,
    assetPath: 'assets/markers/hand_wash_station.svg',
    label: 'Hand wash station',
  ),
  MarkerIconOption(
    key: 'septic_tank',
    icon: Icons.propane_tank,
    assetPath: 'assets/markers/septic_tank.svg',
    label: 'Septic tank',
  ),
  MarkerIconOption(
    key: 'portable_toilet',
    icon: Icons.wc_outlined,
    assetPath: 'assets/markers/portable_toilet.svg',
...
String? suggestMarkerIconForName(String name) {
  ...
  const suggestions = <String, String>{
    ...
    'travel center': 'truck_stop',
    'big rig stop': 'truck_stop',
    'rest stop': 'rest_stop',
    'rest area': 'rest_stop',
    'highway rest': 'rest_stop',
    'picnic area': 'rest_stop',
    'ev charging': 'ev_charging_station',
    'ev charger': 'ev_charging_station',
    'ev charging station': 'ev_charging_station',
    'electric vehicle charging': 'ev_charging_station',
    'charging station': 'ev_charging_station',
    ...
    'public restroom': 'public_restroom',
    'bathroom': 'public_restroom',
    'toilet': 'public_restroom',
    'outhouse': 'outhouse',
    'privy': 'outhouse',
    'latrine': 'latrine',
    'field latrine': 'latrine',
    'trench latrine': 'latrine',
    'composting toilet': 'composting_toilet',
    'compost toilet': 'composting_toilet',
    'hand wash': 'hand_wash_station',
    'hand wash station': 'hand_wash_station',
    'wash station': 'hand_wash_station',
    'hygiene station': 'hand_wash_station',
    'septic': 'septic_tank',
    'septic tank': 'septic_tank',
    'septic system': 'septic_tank',
    'porta potty': 'portable_toilet',
    'porta-potty': 'portable_toilet',
    'portable toilet': 'portable_toilet',
    'porta john': 'portable_toilet',
