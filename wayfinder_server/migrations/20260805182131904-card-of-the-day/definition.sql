...
--
-- Class AccessRole as table access_role
--
...
CREATE TABLE "app_settings" (
    ...
    "darkMapTilesInDarkMode" boolean NOT NULL DEFAULT true,
    "polygonSnapRightAngles" boolean NOT NULL DEFAULT true,
    "polygonSnap45Angles" boolean NOT NULL DEFAULT false,
    "mapMinZoom" double precision NOT NULL DEFAULT 2.0,
    "mapMaxZoom" double precision NOT NULL DEFAULT 18.0,
    "restApiKeyHash" text,
    "updatedAt" timestamp without time zone NOT NULL
);

--
-- Class AppThemeDefinition as table app_theme_definition
--
...
--
-- Class CommsPlan as table comms_plan
--
CREATE TABLE "comms_plan" (
    ...
    "challengeTableJson" text,
    "oneTimePadJson" text,
    "cardOfTheDayJson" text,
...
--
-- Class MapObjectAuditEvent as table map_object_audit_event
--
...
--
-- Class MarkerAttachment as table marker_attachment
--
...
--
-- Class MarkerIconCatalogEntry as table marker_icon_catalog
--
CREATE TABLE "marker_icon_catalog" (
    ...
    "iconBackgroundColor" text NOT NULL DEFAULT '#FFFFFF'::text,
    "materialIcon" text,
...
--
-- Class MarkerIconCategoryDefinition as table marker_icon_category
--
...
--
-- Class RestApiKey as table rest_api_key
--
...
--
-- Class SeasonalOverlay as table seasonal_overlay
--
...
--
-- Class UserClientPreferences as table user_client_preferences
--
...
--
-- Class UserMembership as table user_membership
--
...
--
-- Class WatchLogEntry as table watch_log_entry
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('wayfinder', '20260805182131904-card-of-the-day', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260805182131904-card-of-the-day', "timestamp" = now();
